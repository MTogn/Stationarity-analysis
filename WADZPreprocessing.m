...
function [tiltDataLong,demozoneRawDepth] = WADZPreprocessing();
    ...
    if ~exist('tiltDataLong')
        tiltDataLong = readmatrix('C:\Users\michael\Documents\ADCP\DEMOZONE\completeNWDZTiltData.csv');
        tiltDataLong = tiltDataLong(:,[1 9:10]);
    end
    
    if ~exist('demozoneRawDepth')
        demozoneRawDepth = readmatrix('C:\Users\michael\Documents\ADCP\DEMOZONE\demozoneRawDepth.csv');
